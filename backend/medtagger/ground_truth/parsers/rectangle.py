...
class RectangleLabelElementParser(base.LabelElementParser):
    ...
    def __init__(self) -> None:
        """Initialize parser."""
        super(RectangleLabelElementParser, self).__init__()

    def convert_to_numpy(self, label_elements: List[models.RectangularLabelElement], resize_image: bool = False) -> np.ndarray:
    ...
    def compute_intersection_over_union(self, first_label_element: np.ndarray, second_label_element: np.ndarray) -> float:
        ...
        first_label_field = (first_label_element[2] - first_label_element[0]) * (first_label_element[3] - first_label_element[1])
        second_label_field = (second_label_element[2] - second_label_element[0]) * (second_label_element[3] - second_label_element[1])
